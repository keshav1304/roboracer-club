...
setup(
    name=package_name,
    version='0.1.0',
    packages=[package_name, 'racing_algo'],
    data_files=[
        ...
        (os.path.join('share', package_name, 'config'),
         ['amcl_params.yaml', 'f1tenth_online_async.yaml']),
    ],
    ...
    entry_points={
        'console_scripts': [
            ...
            'follow_gap = racing_algo.follow_gap:main',
            'wall_follow = racing_algo.wall_follow:main',
            'pure_pursuit_node = racing_algo.pure_pursuit_node:main',
            'mpc_node = racing_algo.mpc_node:main',
            'rrt = racing_algo.rrt_node:main',
            'rrt_star = racing_algo.rrt_node:main_rrt_star',
            'waypoint_visualizer = racing_algo.waypoint_visualizer_node:main',
        ],
    },
)
